...
import { LayoutDashboard, Kanban, BarChart2, FileText, BookOpen, Clapperboard, Library, Receipt, ShieldCheck, Settings, LogOut, Sparkles } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/reviews',   icon: Clapperboard,    label: 'Reviews' },
